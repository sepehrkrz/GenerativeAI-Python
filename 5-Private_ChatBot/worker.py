...
def init_llm():
    ...
    os.environ["HUGGINGFACEHUB_API_TOKEN"] = "<INSERT_YOUR_HUGGINGFACE_TOKEN_HERE>"
    ...
    llm_hub.client.api_url = 'https://api-inference.huggingface.co/models/tiiuae/falcon-7b-instruct'
